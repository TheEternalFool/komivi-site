...
export const metadata: Metadata = {
  title: "About | Komivi Jarod Manuel Assiamua",
    ...
    <Section>
      <Container>
        <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr]">
          <div>
            <Badge>About</Badge>
            <h1 className="mt-4 text-3xl font-semibold text-text">An academic and analytical journey</h1>
            <p className="mt-6 text-sm leading-relaxed text-muted">{profile.intro}</p>
            <p className="mt-4 text-sm leading-relaxed text-muted">
              The focus is practical research: deploying models in the real world, translating insights into
          ...
          <div className="card space-y-6">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-muted">
                See the full academic timeline on the Education page.
              </p>
            </div>
          </div>
        </div>
